 ...
 */
export declare const historicalPrices: (symbol: string, range?: Range, date?: string, params?: Partial<HistoricalPriceParams>) => Promise<ReadonlyArray<Partial<HistoricalPrice>>>;
