 ...
 */
export declare const quote: (symbol: string, field?: string) => Promise<Quote>;
...
declare type LatestTime = 'tops' | 'sip' | 'previousclose' | 'close';
declare type LatestSource = 'IEX real time price' | '15 minute delayed price' | 'Close' | 'Previous close';
