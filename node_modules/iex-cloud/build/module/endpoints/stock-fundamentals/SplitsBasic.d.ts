 ...
 * @param range
 */
export declare const splitsBasic: (symbol: string, range?: SplitsBasicRange) => Promise<readonly SplitsBasic[]>;
export declare type SplitsBasicRange = '5y' | '2y' | '1y' | 'ytd' | '6m' | '3m' | '1m' | 'next';
