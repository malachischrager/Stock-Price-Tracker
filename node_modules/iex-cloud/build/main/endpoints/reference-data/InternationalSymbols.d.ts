 ...
 */
export declare const internationalSymbols: ({ region, exchange, }: Input) => Promise<readonly InternationalSymbol[]>;
interface Input {
...
export declare type CommonIssueType = SearchSecurityType;
